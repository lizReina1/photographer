...
<body class="hompage bg-accent-light">
    ...
    <section id="billboard" class="padding-large no-padding-top position-relative">
        <div class="image-holder">
            <img src="images/portada.jpg" alt="banner" class="banner-image">
        </div>
        <div class="banner-content content-light style1 text-center col-md-6">
            <h2 class="banner-title">
                Disfruta las fotos de cada evento al que asistes.
            </h2>
            <div class="btn-center">
                <a href="{{ route('login') }}" class="btn btn-medium btn-light">INGRESAR</a>
            </div>
        </div>
    </section>
    <!-- About-->
    <section id="company-services ">
    <h1 class="text-center">Suscripcion</h1>
        <div class="container my-5  d-flex justify-content-center align-items-center">
            ...
            <div class="row ">
                <div class="col ">
                    <div class="card" style="max-width: 300px;">
                        <div class="card-header">
                            <h3 class="text-center">Plan Básico</h3>
                        </div>
                        <div class="card-body">
                            <ul >
                ...
                <div class="col">
                    <div class="card" style="max-width: 300px;">
                        <div class="card-header">
                            <h3 class="text-center">Plan Standard</h3>
                        </div>
                        <div class="card-body">
                            <ul>
                                <li>Acceso a contenido exclusivo</li>
                ...
                <div class="col">
                    <div class="card" style="max-width: 300px;">
                        <div class="card-header">
                            <h3 class="text-center">Plan Pro</h3>
                        </div>
                        <div class="card-body">
                            <ul>
                                <li>Acceso a contenido exclusivo</li>
